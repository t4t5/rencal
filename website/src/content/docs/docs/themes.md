...
`--event-padding-inline` sets the padding inside event blocks in the month and week views and agenda all-day rows. Blocks with a colour marker keep the same padding after the marker.
