...
const textareaStyles =
  "border-transparent placeholder:text-muted-foreground aria-invalid:border-destructive flex field-sizing-content min-h-0 h-9 w-full rounded-md border bg-transparent px-3 py-2 text-sm shadow-xs transition-[color,box-shadow] outline-none ring-transparent disabled:cursor-not-allowed disabled:opacity-50 focus:bg-secondary hover:border-input focus:border-transparent resize-none"
