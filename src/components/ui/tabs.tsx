  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=navigation]/tabs-list:h-auto group-data-[variant=navigation]/tabs-list:flex-none group-data-[variant=navigation]/tabs-list:justify-start group-data-[variant=navigation]/tabs-list:gap-2 group-data-[variant=navigation]/tabs-list:rounded-md group-data-[variant=navigation]/tabs-list:p-2 group-data-[variant=navigation]/tabs-list:text-sm group-data-[variant=navigation]/tabs-list:font-[family-name:var(--font-body)] group-data-[variant=navigation]/tabs-list:font-normal group-data-[variant=navigation]/tabs-list:normal-case group-data-[variant=navigation]/tabs-list:shadow-none group-data-[variant=navigation]/tabs-list:data-[state=active]:text-secondary-foreground",
        className,
      )}
      {...props}
    />
